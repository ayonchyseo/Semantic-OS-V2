...
// gemini-1.5-flash: free-tier compatible + reliably supports responseMimeType JSON mode.
// gemini-2.0-flash and gemini-2.5-flash require billing - they return quota errors on free keys.
